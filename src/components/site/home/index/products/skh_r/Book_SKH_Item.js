...
class Book_SKH_Item extends Component {
    render() {
        return (
            <div className=" info-product col-xs-6 col-sm-4 col-md-4 col-lg-4  pt-3 mt-2">
                ...
                <div>
                    ...
                    <span className="percent-sale text-danger">-{this.props.percent} %</span>
                    <span className="float-end"><h3><a href className="fa-solid fa-cart-plus"></a></h3></span>
                </div>
            </div>
        );
    }
